...
2.&nbsp;<span style="color:#2f6aa6">Demandez&nbsp;à faire débloquer</span>&nbsp;votre compte depuis la page de confirmation de création de votre compte en cliquant sur le bouton&nbsp;<i style="color:#2f6aa6">Demande de déblocage</i>&nbsp;.<br/>
<i>(Si besoin, vous pourrez envoyer votre&nbsp;clé publique (figurant à côté de votre pictogramme et commencçant par 0x) pour déblocage, à l\'adresse:&nbsp;<a target="_blank" href="mailto:secretariat@monnaie-leman.org" rel="noopener" target="_blank" style="color:#2f6aa6">
secretariat@monnaie-leman.org</a>.)</i>
<br/><br/>

3.&nbsp;<span style="color:#2f6aa6">Synchronisez</span>&nbsp;(le cas échéant) votre compte électronique sur vos autres appareils, smartphones et/ou tablettes.
<br/><br/>
<i >Extrait du document: "Marche à suivre: création et synchronisation d’un compte sur l’application Biletujo"</i>:<br/>
...
<br/><br/>
Belles affaires en lémans électroniques !
...
Pour obtenir des e-lémans sur votre compte, veuillez effectuer un versement sur le compte de Monnaie Léman à la Banque Alternative Suisse (IBAN: CH49 0839 0034 3841 1000 2). Important, veuillez indiquer la mention: "e-Léman". Nous créditerons votre compte dans les plus brefs délais.
...
2. Demandez à faire débloquer votre compte depuis la page de confirmation de création de votre compte en cliquant sur le bouton Demande de déblocage .
(Si besoin, vous pourrez envoyer votre clé publique (figurant à côté de votre pictogramme et commencçant par 0x) pour déblocage, à l'adresse:  secretariat@monnaie-leman.org.)

3. Synchronisez (le cas échéant) votre compte électronique sur vos autres appareils, smartphones et/ou tablettes.
...
function getUnlockSubject($type) {
    if ($type==1) {
        return 'Léman électronique: déblocage de votre compte professionnel';
    } else {
        return 'Léman électronique: déblocage de votre compte personnel';
    }
}
...
<span style="color:#2f6aa6" >Bonjour '.$name.'</span>,
<br/><br/>
Votre compte '.$wallet.' est maintenant actif, vous pouvez l\'utiliser.
<br/><br/>
